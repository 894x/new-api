...
var auditContentTemplates = map[string]string{
	...
	"channel.asset_library.update":   "Updated asset library config for channel (ID: ${id})",
	"channel.asset_library.delete":   "Deleted asset library config for channel (ID: ${id})",
	"channel.asset_library.sync":     "Synchronized asset library replicas for channel (ID: ${id})",
