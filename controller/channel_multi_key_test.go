...
func TestMultiKeyEnableRestoresOnlyExhaustedChannels(t *testing.T) {
	...
	require.NoError(t, database.AutoMigrate(&model.Channel{}, &model.Ability{}, &model.ChannelModelOverride{}, &model.User{}, &model.Log{}, &model.AuditLog{}, &model.UserAssetReplica{}, &model.UserAssetGroupReplica{}, &model.ChannelAssetConfig{}))
