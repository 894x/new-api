...
func setupTaskPluginBindChannelTest(t *testing.T) {
	...
	require.NoError(t, database.AutoMigrate(&model.Channel{}, &model.ChannelModelOverride{}, &model.Ability{}, &model.CasbinRule{}, &model.AuthzRole{}, &model.Log{}, &model.AuditLog{}, &model.User{}))
	model.DB = database
