...
func GetAllTask(c *gin.Context) {
	...
	pageInfo.SetItems(tasksToDto(items, true, c.GetInt("role"), c))
...
func GetUserTask(c *gin.Context) {
	...
	pageInfo.SetItems(tasksToDto(items, false, common.RoleCommonUser, c))
	common.ApiSuccess(c, pageInfo)
}

func tasksToDto(tasks []*model.Task, fillUser bool, viewerRole int, contexts ...*gin.Context) []*dto.TaskDto {
	c := &gin.Context{}
