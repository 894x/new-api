...
func getModelRequest(c *gin.Context) (*ModelRequest, bool, error) {
	...
	if strings.Contains(c.Request.URL.Path, "/mj/") {
		...
		c.Set("relay_mode", relayMode)
	} else if taskResponseFormat := common.GetContextKeyString(c, constant.ContextKeyTaskResponseFormat); taskResponseFormat == constant.TaskResponseFormatDoubaoVideo || taskResponseFormat == constant.TaskResponseFormatAliVideo {
