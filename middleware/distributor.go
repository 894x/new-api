...
func getModelRequest(c *gin.Context) (*ModelRequest, bool, error) {
	...
	if c.Request.Method == http.MethodGet && (nativeFormat == constant.TaskResponseFormatDoubaoVideo || nativeFormat == constant.TaskResponseFormatAliVideo || nativeFormat == constant.TaskResponseFormatMiniMaxVideoV2) {
