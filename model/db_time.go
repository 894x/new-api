...
// getDBTimestampWithDB keeps timestamp reads on the caller's transaction
// connection. This is required for single-connection SQLite databases and
// preserves transaction ordering on every dialect.
