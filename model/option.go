...
func InitOptionMap() {
	...
	common.OptionMap["WechatPayMerchantSerialNumber"] = setting.WechatPayMerchantSerialNumber
	...
	common.OptionMap["ModelRequestRateLimitTPM"] = strconv.Itoa(setting.ModelRequestRateLimitTPM)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "WechatPayMerchantSerialNumber":
		setting.WechatPayMerchantSerialNumber = value
	...
	case "ModelRequestRateLimitTPM":
		setting.ModelRequestRateLimitTPM, _ = strconv.Atoi(value)
