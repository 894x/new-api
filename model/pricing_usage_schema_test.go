...
func TestPricingAliasCarriesPluginUsageSchemaAndTailExpr(t *testing.T) {
	...
	require.NoError(t, ratio_setting.UpdateModelPriceByJSONString(`{"alias-model":0.003}`))
	const pluginKey = "pricing-usage-probe"
  ...
  seconds: {type: "number", unit: "second", description: "Estimated duration."}
	...
	require.NoError(t, config.GlobalConfig.LoadFromDB(map[string]string{
		"billing_setting.billing_mode": `{"alias-model":"ratio","pricing-usage-model":"tiered_expr","alias-own-expr":"tiered_expr"}`,
