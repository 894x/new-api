...
func TestDoubaoPluginRetainsPublicModelsAndDefaultPrices(t *testing.T) {
	assert.Subset(t, taskplugin.New(doubaoPlugin(t)).GetModelList(), []string{"doubao-seedance-1-0-pro-250528", "doubao-seedance-1-0-lite-t2v", "doubao-seedance-1-0-lite-i2v", "doubao-seedance-1-5-pro-251215",
