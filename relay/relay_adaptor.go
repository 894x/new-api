...
var taskPluginKeys = map[constant.TaskPlatform]string{
	constant.TaskPlatform(strconv.Itoa(constant.ChannelTypeSeedanceSLS)): "seedance-sls",
	constant.TaskPlatform(strconv.Itoa(constant.ChannelTypeTokenHub)):    "tencent-tokenhub",
