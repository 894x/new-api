...
type ChannelSettings struct {
	...
	OllamaNativeClaude        bool   `json:"ollama_native_claude,omitempty"`
	...
	// the executing plugin. TaskPluginKey remains the single type-105 binding
...
type DoubaoVideoAPIMode string

const (
	DoubaoVideoAPIModeV3               DoubaoVideoAPIMode = "v3"
	DoubaoVideoAPIModeVideoGenerations DoubaoVideoAPIMode = "video_generations"
	DoubaoVideoAPIModeCustom           DoubaoVideoAPIMode = "custom"
)
...
type ChannelOtherSettings struct {
	...
	DoubaoVideoAPIMode                    DoubaoVideoAPIMode         `json:"doubao_video_api_mode,omitempty"`
	DoubaoVideoSubmitPath                 string                     `json:"doubao_video_submit_path,omitempty"`
