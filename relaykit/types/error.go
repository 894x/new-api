...
const (
	...
	// new api error
	ErrorCodeChannelModelCapacityExhausted ErrorCode = "channel_model_capacity_exhausted"
	ErrorCodeCountTokenFailed              ErrorCode = "count_token_failed"
	ErrorCodeModelPriceError               ErrorCode = "model_price_error"
	ErrorCodeModelRequestTPMCheckFailed    ErrorCode = "model_request_tpm_check_failed"
	ErrorCodeModelRequestTPMLimitExceeded  ErrorCode = "model_request_tpm_limit_exceeded"
