...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/:id/document", controller.GetModelDocumentEditor)
			modelsRoute.PUT("/:id/document", controller.SaveModelDocumentEditorDraft)
			modelsRoute.POST("/:id/document/publish", controller.PublishModelDocumentEditor)
			modelsRoute.POST("/:id/document/preview", controller.PreviewModelDocumentEditor)
			modelsRoute.DELETE("/:id/document", controller.DeleteModelDocumentEditor)
