...
func channelAffinityStatsTestIdentity(t *testing.T) (string, string) {
	t.Helper()
	id := channelAffinityStatsTestSequence.Add(1)
	name := fmt.Sprintf("%s_%d", t.Name(), id)
	return name, name + "_fp"
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := channelAffinityStatsTestIdentity(t)
	usingGroup := "default"
