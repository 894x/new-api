...
func appendParameterCapabilityInfo(relayInfo *relaycommon.RelayInfo, other map[string]interface{}) {
	...
	adminInfo["parameter_capability"] = relayInfo.ParameterCapabilityAudit
}
