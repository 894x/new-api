...
var defaultModelRatio = map[string]float64{
	...
	"doubao-seedance-2-0-260128": 0.046 * RMB, // ¥46 / 1M tokens
	"doubao-seedance-2-0":        0.046 * RMB, // Seedance SLS alias

	"doubao-seedance-2-0-fast-260128": 0.037 * RMB, // ¥37 / 1M tokens
