...
export function BalanceCell({ channel }: { channel: Channel }) {
  ...
  const [balanceResponseSummary, setBalanceResponseSummary] = useState<
    string | null
  >(null)
  ...
  const handleClickUpdate = async () => {
    ...
    try {
      ...
      } else if (response.success && response.response_summary !== undefined) {
        setCurrentRow(channel)
        setBalanceResponseSummary(response.response_summary)
      } else {
  ...
  return (
    <TooltipProvider>
      ...
      />
      {balanceResponseSummary !== null && (
        <BalanceQueryDialog
          initialResponseSummary={balanceResponseSummary}
          open
          onOpenChange={(open) => {
            if (!open) {
              setBalanceResponseSummary(null)
            }
          }}
        />
      )}
