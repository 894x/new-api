        ...
        >
                        ...
                        render={({ field }) => (
                          <FormItem className={sideDrawerSwitchItemClassName()}>
                            <div className='flex flex-col gap-0.5'>
                              <FormLabel>{t('Model document')}</FormLabel>
                              <FormDescription>
                                {savedModel?.doc_available
                                  ? t(
                                      'Publish the independent HTML document for this model.'
                                    )
                                  : t(
                                      'No HTML document is available for this model.'
                                    )}
                              </FormDescription>
                            </div>
                            <FormControl>
                              <Switch
                                ...
                                disabled={!savedModel?.doc_available}
                              />
                            </FormControl>
                          </FormItem>
                        )}
          ...
          {props.open && section === 'connections' && savedModel && (
            <div className='min-h-0 flex-1 overflow-auto'>
              ...
              {savedModel.name_rule === 0 && (
                <div className='p-4'>
                  <ModelRoutingOverridesEditor model={savedModel.model_name} />
                </div>
              )}
            </div>
          )}
