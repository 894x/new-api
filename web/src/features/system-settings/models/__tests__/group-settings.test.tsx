...
const schema = z.object({
  ...
  GroupModelChannelGroups: z.string(),
  ModelTieredRatios: z.string(),
})
...
describe('group settings workspace', () => {
  ...
  it('keeps unfinished visibility rules while switching sections and supports keyboard tabs', async () => {
    ...
    const visibility = within(
      screen.getByRole('tabpanel', { name: 'Group visibility' })
    )
    await user.click(visibility.getByRole('button', { name: 'Add rule' }))
    expect(
