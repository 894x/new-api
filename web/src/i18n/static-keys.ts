...
export const STATIC_I18N_KEYS = [
  'Asset library request: {{action}} ({{id}})',
  // Header navigation
  'Home',
  'Console',
  'Model Square',
  ...
  'Critical threshold',
  'Relative score that triggers rapid traffic shedding.',
  'Candidate advantage',
  ...
  'Probe fraction must be at least 0',
  'Probe fraction must be at most 0.999',
  'Use no more than two decimal places',
  'Use no more than three decimal places',
  'Threshold must be at least 1.01',
  'Candidate advantage must be at least 1.01',
  'Aggressiveness must be at least 0.01',
  'Aggressiveness must be 1 or less',
  'Recovery step must be at least 0.001',
  'Recovery step must be 1 or less',
  'Probe fraction must be greater than 0 when enabled',
  'Minimum samples cannot exceed maximum samples',
  'Hard failure threshold cannot exceed maximum samples',
  'Recovery threshold must be below degradation threshold',
  'Critical threshold must exceed degradation threshold',
  'Maintenance',
